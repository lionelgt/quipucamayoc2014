...
public interface PlazaCASMapper {

    @Select(value = "{call qpdatagestion.plaza_wkg.sp_save_plaza( #{cont.numCont},#{cont.ini}," +
            " #{cont.fin},#{cont.horas},#{cont.tipo},#{cont.udId},#{cont.idCargo},#{cont.idServidor}," +
            " #{cont.monto} ) }")
    public void savePlaza(@Param("cont") AdendaCAS contrato);

    @Select(value = "{call qpdatagestion.plaza_wkg.sp_remove_plaza(#{cont.idPlaza}) }")
    public void removePlaza(@Param("cont") AdendaCAS contrato);
    ...
    @Select(value = "SELECT * " +
            ...
            "  WHERE p.c_plaza_id        = #{cont.idPlaza} " +
    ...
    public List<AdendaCAS> historiaPlaza(@Param("cont") AdendaCAS contrato);
}
