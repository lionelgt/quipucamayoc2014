	...
	ErzaManager.on("initialize:after", function(){
		if(Backbone.history){
			require(["apps/contratos/contratos_app","apps/planillas/planillas_app","apps/inicio/inicio_app","apps/servidores/servidores_app",
                ...
                "apps/resoluciones/resoluciones_app","apps/asistencia/asistencia_app"], function () {       //para cada modulo agregar la url donde se encuentra apps/planillas/planillas_app
